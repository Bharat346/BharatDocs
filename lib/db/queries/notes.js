...
export async function getNotesByParentSlug(parentSlug, tagSlug) {
  ...
  return cached("queries", key, () => _getNotesByParentSlug(parentSlug, tagSlug));
}
...
export async function getNoteBySlug(slug) {
  return cached("queries", `note:${slug}`, () => _getNoteBySlug(slug));
}
...
export async function getAllNotes() {
  return cached("queries", "notes:all", _getAllNotes);
}
