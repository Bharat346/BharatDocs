    ...
    <div className="space-y-1">
      ...
      <div className="flex items-center">
        <Link
          ...
          className={`flex-1 flex items-center gap-3 px-4 py-3.5 rounded-xl text-[clamp(0.95rem,4vw,1.125rem)] font-black transition-all ${
            theme === "dark"
              ...
              <div className="ml-6 pl-4 border-l space-y-1">
                {item.children.map((child) => (
                  <Link
                    ...
                    onClick={closeMobile}
                    prefetch={shouldPrefetch()}
                    className={`flex items-center gap-2 px-3 py-2 rounded-lg text-[clamp(0.85rem,3vw,0.95rem)] font-black transition-all ${
                      theme === "dark"
                    ...
                    <div className="grid grid-cols-2 gap-2 px-4">
                      {category.subjects.map((subject) => (
                        <Link
                          ...
                          onClick={closeMobile}
                          prefetch={shouldPrefetch()}
                          className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm transition-all font-black ${
                            theme === "dark"
